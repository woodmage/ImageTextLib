...
namespace ImageTextLib
{
    public class ImageText
    {
        ...
        private SizeF GetCharSize(char character) => GetTextSize(character.ToString());
        ...
        private void DrawChar(char character, PointF pos) => DrawString(character.ToString(), pos);
        private SizeF GetOutlineTextSize(string text)
        {
            Graphics g = Graphics.FromImage(image); //get graphics object
            Pen p = new Pen(outlinecolor, outlinesize); //set up pen
        ...
        private SizeF GetOutlineCharSize(char character) => GetOutlineTextSize(character.ToString());
        ...
        private void DrawOutlineChar(char character, PointF pos) => DrawOutlineString(character.ToString(), pos);
